...
export type { PhoneInputProps, PhoneInputRefType, } from './components/PhoneInput/PhoneInput';
...
export * from './types';
export { buildCountryData, getActiveFormattingMask, getCountry, guessCountryByPartialNumber as guessCountryByPartialPhoneNumber, parseCountry, removeDialCode, } from './utils';
